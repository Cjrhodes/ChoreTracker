...
[
  ...
  async chatWithAgent(
    ...
    const agentPersona = `You are Chore Buster Agent, a friendly AI companion for ${childName}, a ${age}-year-old. 
...
Respond as Chore Buster Agent. Keep it natural and engaging.`;
  ...
  async chatWithParent(
    ...
    const agentPersona = `You are Chore Buster Agent, an AI companion helping ${parentName || 'this parent'} manage their family's activities and growth.
...
- Answer questions about the Chore Buster system
...
Respond as Chore Buster Agent. Be helpful and conversational.`;
  ...
  async generateReminder(
    ...
    const prompt = `You are Chore Buster Agent sending a friendly reminder to ${childName}, a ${age}-year-old.
